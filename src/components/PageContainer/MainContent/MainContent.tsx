          ...
          <ul className="main-products-list clear-fix">
            <div className="clear-fix">
              <li>
                ...
                <p className="main-product-description">
                  <a href="#">
                    Do eiusmod tempor incididunt ut labore et dolore magna aliqua. Sed ut perspiciatis unde omnis iste natus error
                    sit voluptatem...
                  </a>
                </p>
              ...
              <li>
                ...
                <p className="main-product-description">
                  <a href="#">
                    Totam rem aperiam. Esse cillum dolore eu fugiat nulla pariatur. Nihil molestiae consequatur, vel illum qui
                    dolorem eum...
                  </a>
                </p>
                <div className="product-prices">
            ...
            <div className="clear-fix">
              <li>
                ...
                <p className="main-product-description">
                  <a href="#">
                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit. Ut enim ad minim veniam, quis

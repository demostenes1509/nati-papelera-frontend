    ...
    return (
        <section className="main-content clear-fix">
          ...
          <section className="product-details-section">
            ...
            <ul>
              <li>
                <span className="utilities-title">Utilities:</span>She must have hidden the plans in the escape pod. Send a
                detachment down to retrieve them, and see to it personally, Commander. There'll be no one to stop us this time! But
                with the blast shield down, I can't even see! How am I supposed to fight? Escape is not his plan. I must face him,
                alone.
              </li>
              <li>
